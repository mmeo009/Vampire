        ...
        foreach (string asset in importedAssets)
        {
            ...
            using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
                ...
                foreach (string sheetName in sheetNames)
                {
					...
					cell = row.GetCell(10); p.firstSkillName = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(11); p.firstSkillCoolDown = (float)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(12); p.secondSkillName = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(13); p.secondSkillCoolDown = (float)(cell == null ? 0 : cell.NumericCellValue);
					cell = row.GetCell(14); p.cost = (int)(cell == null ? 0 : cell.NumericCellValue);
